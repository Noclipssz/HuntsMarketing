export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 pt-20 overflow-hidden">
      ...
      {/* Mobile - Mira decorativa de fundo */}
      <div className="lg:hidden absolute top-[40%] right-[-60px] -translate-y-1/2 pointer-events-none">
        <svg
          width="280"
          height="280"
          viewBox="0 0 400 400"
          fill="none"
          className="animate-spin-slow opacity-[0.20]"
        >
          <circle cx="200" cy="200" r="180" stroke="#FF8C00" strokeWidth="1.5" />
          <circle cx="200" cy="200" r="140" stroke="#FF8C00" strokeWidth="1.5" />
